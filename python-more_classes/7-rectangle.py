...
string/repr representations, instance tracking, deletion message, and
custom print symbol support.
"""
...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        """Initialize a new Rectangle, validating attributes and updating
        instance count."""
        self.width = width
        self.height = height
    ...
    def __str__(self):
        """Return the rectangle drawn with the print_symbol, or an empty
